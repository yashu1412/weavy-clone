...
import type { SocialLink } from "../../components/sections/types/index";
...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      {/* main */}
      <div className="relative bg-[#aeb3a9] max-w-[1344px] min-h-[270px] rounded-none md:rounded-tr-[30px] mt-0 md:mt-1 mr-0 md:mr-16 pt-11 md:pt-17 pb-8 md:pb-8 px-4 md:px-[5%]">
